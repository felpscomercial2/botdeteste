...
def init_db():
    ...
    for col, ddl in (("cesar_mood", "TEXT"), ("cesar_mood_timestamp", "DATETIME")):
        try:
            ...
            pass
    # Colunas novas do sistema de memorias
    for col, ddl in (("category", "TEXT DEFAULT 'geral'"), ("updated_at", "DATETIME")):
        try:
            c.execute(f"ALTER TABLE user_facts ADD COLUMN {col} {ddl}")
        except sqlite3.OperationalError:
            pass
