...
def update_progress(user_id):
    ...
    if new_points >= 40 and namoro == 0 and fase == 'conhecendo':
        new_fase = 'pedir_namoro'
    elif namoro == 1 and segredo == 0 and new_points >= 85:
        new_fase = 'revelar_segredo'
    elif namoro == 1 and segredo == 0 and new_points >= 70:
        new_fase = 'segredo_pistas'
    elif namoro == 1 and segredo == 0 and new_points >= 55:
        new_fase = 'segredo_evasivo'
    elif namoro == 1 and segredo == 0:
        new_fase = 'namorando'
    elif segredo == 1 and new_points >= 120 and noivado == 0:
        new_fase = 'pedir_noivado'
    elif noivado == 1 and new_points >= 190 and casamento == 0:
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ---- FOTO recebida do usuário ----
        ...
        try:
            ...
            user_text = "[O usuário mandou uma foto, mas você não conseguiu abrir direito. Diga isso de um jeito natural e peça para mandar de novo.]"
