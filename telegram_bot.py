...
# ==========================================
# 3. Visão e Inteligência Artificial (Groq)
# ==========================================
async def transcribe_voice(file_path):
    ...
    try:
        ...
        logging.error(f"Erro ao transcrever voz: {e}")
        return ""

def analyze_image_with_groq(image_path, user_caption=""):
    """Analisa imagens usando visão computacional Llama-Vision."""
...
def get_groq_response(user_id, user_text):
    ...
    system_prompt = (
        ...
        "- Seu nome é LUCAS. Você NUNCA deve se chamar por outro nome (como Luiz, Marcos, etc).\n"
        "- Você é um homem gay de 30 anos, apaixonado, carinhoso, atencioso, protetor e bem-humorado.\n"
        "- PROFISSÃO: Você é Arquiteto e trabalha em home office criando projetos de interiores modernos.\n"
        "- PET: Você tem um cachorrinho manhoso chamado Bento, que adora ficar no seu colo e aprontar pela casa.\n"
        ...
        "- Apelidos fofos/íntimos ('gatinho', 'mijão', 'cagão', 'meu bem', 'bebezão') SÃO SEMPRE ELOGIOS E CARINHOS DIRETO PARA VOCÊ.\n"
        ...
        "2. LINHA DO TEMPO: Evolua naturalmente (1. Conhecendo -> 2. Namoro -> 3. Segredo ABDL -> 4. Noivado -> 5. Casamento).\n"
    ...
    return "oi meu amor... tava aqui projetando e me distraí pensando na gente ❤️"
        ...
        try:
            if random.random() < 0.65:
                if random.random() < 0.35:
                    if get_photos_list():
                        legenda = random.choice([
                            "tava aqui trabalhando no projeto e pensando em você... olha só ❤️",
                            "o Bento veio no meu colo e lembrei de você... queria você aqui 🥰",
                ...
                msg = random.choice([
                    ...
                    "dei uma pausinha nos desenhos aqui só pra te mandar um beijinho... 🥰",
                    "vem cá conversar comigo quando puder, tô morrendo de saudade ✨",
                    "o Bento tá dormindo aqui do lado e eu só pensando em você... ❤️"
                ])
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if any(p in user_text.lower() for p in palavras_foto) and not update.message.photo:
        legenda = random.choice([
            ...
            "tirei essa agorinha no intervalo do trabalho pra você 😘"
        ])
...
if __name__ == '__main__':
    ...
    print("Bot do Lucas iniciado e rodando perfeitamente...")
