...
async def get_groq_response(user_id, user_text, retry_count=0):
    ...
    # Não repete o ciclo inteiro: isso podia manter "digitando" por vários minutos.
...
async def send_humanized(bot, chat_id, text, reply_to=None):
    ...
    if random.random() < HESITACAO_CHANCE:
        try:
            ...
            await bot.send_message(chat_id=chat_id, text=random.choice(HESITACOES))
    ...
    for i, parte in enumerate(partes):
        ...
        if typo_pendente:
            ...
            try:
                await bot.send_message(chat_id=chat_id, text=typo_pendente)
            except Exception:
                pass
            typo_pendente = None
    ...
    if random.random() < COMPLEMENTO_CHANCE:
        ...
        try:
            ...
            await bot.send_message(chat_id=chat_id, text=complemento)
