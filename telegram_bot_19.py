...
async def get_groq_response(user_id, user_text, retry_count=0):
    ...
    system_prompt = (
        ...
        "IDENTIDADE DO LUCAS:\n"
        f"- Você é o César, um homem gay de 30 anos. Também atende carinhosamente por {BOT_NICKNAME} quando o parceiro quiser. {nome_clause}\n"
        f"{weather_info}"
        f"{sleep_info}\n"
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ---- FOTO recebida do usuário ----
        ...
        try:
            ...
            save_photo_memory(user_id, photo.file_id, vision_description)
